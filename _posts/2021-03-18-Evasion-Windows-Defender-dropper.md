...
published: true
layout: post
title: "Evasion de Windows Defender grâce à un dropper"
description: "Cet article décrit comment rendre indétectable n'importe quel malware auprès de Windows Defender."
lang: fr_FR
category: redteam,malware,raccourci,dropper,evasion
---
![Evasion de Windows Defender grâce à un dropper](/assets/images/2021-03-28-Evasion-Windows-Defender-dropper/illustration.PNG)
...
[![Taux de détection du malware Quasar](/assets/images/2021-03-28-Evasion-Windows-Defender-dropper/scan_malware.PNG)](/assets/images/2021-03-28-Evasion-Windows-Defender-dropper/scan_malware.PNG)
...
[![Taux de détection de l'injecteur (dropper)](/assets/images/2021-03-28-Evasion-Windows-Defender-dropper/scan_dropper.PNG)](/assets/images/2021-03-28-Evasion-Windows-Defender-dropper/scan_dropper.PNG)
...
[![Taux de détection de l'injecteur (dropper)](/assets/images/2021-03-28-Evasion-Windows-Defender-dropper/Quasar.PNG)](/assets/images/2021-03-28-Evasion-Windows-Defender-dropper/Quasar.PNG)
...
[![Enregistreur de frappes (keylogger)](/assets/images/2021-03-28-Evasion-Windows-Defender-dropper/keylogger.PNG)](/assets/images/2021-03-28-Evasion-Windows-Defender-dropper/keylogger.PNG)

Il est également possible d'envoyer des messages à la victime :

[![Message box Quasar](/assets/images/2021-03-28-Evasion-Windows-Defender-dropper/message_box.PNG)](/assets/images/2021-03-28-Evasion-Windows-Defender-dropper/message_box.PNG)
...
[![Exclusion Windows Defender ajoutée par l'injecteur](/assets/images/2021-03-28-Evasion-Windows-Defender-dropper/exclusion.PNG)](/assets/images/2021-03-28-Evasion-Windows-Defender-dropper/exclusion.PNG)
